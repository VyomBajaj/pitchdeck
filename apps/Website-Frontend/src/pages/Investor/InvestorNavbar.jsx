    ...
    <nav className="bg-gradient-to-r from-blue-600 to-blue-800 p-4 shadow-lg backdrop-blur-md w-full">
      <div className="flex justify-between items-center max-w-screen-xl mx-auto px-4">
        ...
        <ul className="flex items-center space-x-6 md:space-x-8">
          ...
          <li>
            <a href="/investordashboard" className="text-white font-medium hover:text-blue-300 transition duration-200">
              Dashboard
            </a>
          </li>
        </ul>
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          <a href="/view_investor_profile" className="flex items-center space-x-4 hover:text-blue-300 transition duration-200">
